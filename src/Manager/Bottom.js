    ...
    render(){
        return(
            ...
            <div style = {{backgroundColor:"black", height:'100px', marginTop:'116px'}}>
               ...
               <Button className="regular" variant="dark" style={{borderColor:'white', backgroundColor:'black', color:'white', fontSize: '17px', borderRadius:'30px', width:'200px', height:'45px', fontWeight:'bolder', marginLeft:'1000px', marginTop:'20px'}}>צריכים עזרה? לחצו כאן</Button>{' '}
